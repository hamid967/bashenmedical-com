...
import { Route as AuthenticatedAdminSpecialtiesRouteImport } from './routes/_authenticated/admin.specialties'
...
const AuthenticatedAdminDoctorTodayRoute =
  AuthenticatedAdminDoctorTodayRouteImport.update({
    id: '/doctor-today',
    path: '/doctor-today',
    getParentRoute: () => AuthenticatedAdminRoute,
  } as any)
...
const AuthenticatedAdminInsuranceRoute =
  AuthenticatedAdminInsuranceRouteImport.update({
    id: '/insurance',
    path: '/insurance',
    getParentRoute: () => AuthenticatedAdminRoute,
  } as any)
...
const AuthenticatedAdminSpecialtiesRoute =
  AuthenticatedAdminSpecialtiesRouteImport.update({
    id: '/specialties',
    path: '/specialties',
    getParentRoute: () => AuthenticatedAdminRoute,
  } as any)
...
const AuthenticatedAdminFilesIdRoute =
  AuthenticatedAdminFilesIdRouteImport.update({
    id: '/$id',
    path: '/$id',
    getParentRoute: () => AuthenticatedAdminFilesRoute,
  } as any)
const AuthenticatedAdminInboxIdRoute =
  AuthenticatedAdminInboxIdRouteImport.update({
    id: '/$id',
    path: '/$id',
...
const AuthenticatedAdminIntegrationsKeyRoute =
  AuthenticatedAdminIntegrationsKeyRouteImport.update({
    id: '/$key',
    path: '/$key',
...
export interface FileRouteTypes {
  ...
  id:
    ...
    | '/_authenticated/admin/specialties'
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_authenticated/admin/doctor-today': {
      id: '/_authenticated/admin/doctor-today'
      path: '/doctor-today'
      fullPath: '/admin/doctor-today'
      preLoaderRoute: typeof AuthenticatedAdminDoctorTodayRouteImport
      parentRoute: typeof AuthenticatedAdminRoute
    }
    '/_authenticated/admin/doctors': {
    ...
    '/_authenticated/admin/insurance': {
      id: '/_authenticated/admin/insurance'
      path: '/insurance'
      fullPath: '/admin/insurance'
      preLoaderRoute: typeof AuthenticatedAdminInsuranceRouteImport
      parentRoute: typeof AuthenticatedAdminRoute
    }
    '/_authenticated/admin/integrations': {
    ...
    '/_authenticated/admin/specialties': {
      id: '/_authenticated/admin/specialties'
      path: '/specialties'
      fullPath: '/admin/specialties'
      preLoaderRoute: typeof AuthenticatedAdminSpecialtiesRouteImport
      parentRoute: typeof AuthenticatedAdminRoute
    }
    '/_authenticated/admin/users': {
    ...
    '/_authenticated/admin/files/$id': {
      ...
      parentRoute: typeof AuthenticatedAdminFilesRoute
    }
    '/_authenticated/admin/inbox/$id': {
      id: '/_authenticated/admin/inbox/$id'
      path: '/$id'
      fullPath: '/admin/inbox/$id'
    ...
    '/_authenticated/admin/integrations/$key': {
      id: '/_authenticated/admin/integrations/$key'
      path: '/$key'
      fullPath: '/admin/integrations/$key'
      preLoaderRoute: typeof AuthenticatedAdminIntegrationsKeyRouteImport
...
const AuthenticatedAdminFilesRouteChildren: AuthenticatedAdminFilesRouteChildren =
  {
    AuthenticatedAdminFilesIdRoute: AuthenticatedAdminFilesIdRoute,
  }

const AuthenticatedAdminFilesRouteWithChildren =
  AuthenticatedAdminFilesRoute._addFileChildren(
    AuthenticatedAdminFilesRouteChildren,
  )
...
const AuthenticatedAdminInboxRouteWithChildren =
  AuthenticatedAdminInboxRoute._addFileChildren(
    AuthenticatedAdminInboxRouteChildren,
  )
...
const AuthenticatedAdminInsuranceRouteChildren: AuthenticatedAdminInsuranceRouteChildren =
  {
    AuthenticatedAdminInsuranceApprovalIdRoute:
      AuthenticatedAdminInsuranceApprovalIdRoute,
  }

const AuthenticatedAdminInsuranceRouteWithChildren =
  AuthenticatedAdminInsuranceRoute._addFileChildren(
    AuthenticatedAdminInsuranceRouteChildren,
  )

interface AuthenticatedAdminIntegrationsRouteChildren {
  AuthenticatedAdminIntegrationsKeyRoute: typeof AuthenticatedAdminIntegrationsKeyRoute
}

const AuthenticatedAdminIntegrationsRouteChildren: AuthenticatedAdminIntegrationsRouteChildren =
  {
    AuthenticatedAdminIntegrationsKeyRoute:
      AuthenticatedAdminIntegrationsKeyRoute,
  }
...
const AuthenticatedAdminSettingsRouteChildren: AuthenticatedAdminSettingsRouteChildren =
  {
    AuthenticatedAdminSettingsKeyRoute: AuthenticatedAdminSettingsKeyRoute,
  }
