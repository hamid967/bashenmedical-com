...
export const SOAP_TEMPLATES: SoapTemplate[] = [
  ...
  },
  {
    ...
    objective: "- ض/د ___ , نبض ___ , وزن ___ \n- ارتفاع الرحم: \n- نبض الجنين: \n- الوضعية: ",
    assessment: "- الحمل ___ أسبوع، الحالة: طبيعي/عالي الخطورة — السبب: ",
    plan: "- الفحوصات: (CBC, GDM, U/S…)\n- المكملات: \n- تعليمات الخطر: \n- الموعد القادم: ",
  },
  {
    id: "preop",
    ...
    plan: "- الفحوصات المطلوبة قبل العملية: \n- استشارات: \n- تعليمات الصيام والأدوية: \n- الموافقة المستنيرة: ",
  },
  {
    id: "mentalhealth",
    label_ar: "صحة نفسية",
