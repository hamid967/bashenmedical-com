    ...
    async ({
      ...
      const [
        ...
        safeCount(sb, "appointments", (q: Sb) =>
          withBranch(q.gte("appointment_date", fromDate).lte("appointment_date", toDate)),
        ),
        safeCount(sb, "appointments", (q: Sb) =>
          withBranch(
            q
        ...
        safeCount(sb, "appointments", (q: Sb) =>
          withBranch(
            q
              .gte("appointment_date", sevenDaysBack)
              .lte("appointment_date", toDate)
              .eq("status", "no_show"),
          ),
        ),
        ...
        safeCount(sb, "availability_slots", (q: Sb) =>
          withBranch(
            q.gte("slot_date", fromDate).lte("slot_date", toDate).eq("status", "available"),
          ),
        ),
