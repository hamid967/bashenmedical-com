    ...
    <footer className="mt-16 bg-gradient-to-b from-muted/40 to-muted/70 border-t border-border relative">
      ...
      <div className="container-app py-12 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="rounded-2xl p-4 bg-background/50 jazan-hairline">
          ...
          <p className="text-sm text-muted-foreground leading-6 mb-4">{tf("desc")}</p>
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <span className="inline-flex items-center gap-1 rounded-md bg-background border border-[var(--jazan-gold,#C7A46B)]/40 px-2 py-1 text-[11px] font-medium">
              <Award className="h-3.5 w-3.5 text-primary" /> {tf("moh")}
            </span>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="mt-4 flex items-center gap-3">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              aria-label={tf("instagramAria")}
              className="text-muted-foreground hover:text-primary"
            >
              <Instagram className="h-5 w-5" aria-hidden="true" />
              <span className="sr-only">{tf("instagram")}</span>
            </a>
          </div>
        </div>
      </div>
      ...
      <div className="border-t border-border">
        <div className="container-app py-4 text-xs text-muted-foreground flex flex-wrap items-center justify-between gap-2">
          <span>
            © {new Date().getFullYear()} {brandName} — {t("footer_rights")}
          </span>
