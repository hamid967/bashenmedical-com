            ...
            return (
              ...
              >
                <div className="flex items-center gap-3">
                  <div aria-hidden="true" className="h-14 w-14 shrink-0 rounded-full bg-primary/10 text-primary grid place-items-center font-bold overflow-hidden">
                    {d.photo_url ? <img src={d.photo_url} alt="" className="h-full w-full object-cover"/> : name.charAt(0)}
                  </div>
