  ...
  head: () => ({
    meta: [
      ...
      { title: "الطوارئ 24/7 — مجمع باعشن الطبي" },
      {
        name: "description",
        content:
          "أرقام الطوارئ والاتصال العاجل بمجمع باعشن الطبي في صبيا، مع إرشادات السلامة قبل وصول الإسعاف.",
      },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          description: "خدمة الطوارئ الطبية على مدار الساعة بمجمع باعشن الطبي، صبيا، جازان.",
      ...
      <section className="bg-gradient-to-br from-destructive/15 to-destructive/5 border-b border-border">
        <div className="container-app py-14">
          ...
          <p className="mt-3 text-muted-foreground max-w-2xl">
            إذا كنت أو أحد من حولك في حالة خطر، لا تتردد. اتصل بأقرب رقم أدناه أو توجّه مباشرة لأقرب
            طوارئ.
          </p>
          <div className="mt-6 grid gap-4 sm:grid-cols-3">
            <a
              href="tel:997"
              className="rounded-2xl bg-destructive text-destructive-foreground p-5 shadow-lg hover:opacity-95"
            >
            ...
            <a
              href="tel:937"
              className="rounded-2xl bg-primary text-primary-foreground p-5 shadow-lg hover:opacity-95"
            >
            ...
            <a
              ...
              className="rounded-2xl bg-background border-2 border-primary text-foreground p-5 hover:bg-muted"
            >
              <div className="text-xs text-muted-foreground mb-1">مجمع باعشن الطبي</div>
              <div className="text-3xl font-black tracking-wide text-primary">
                {SITE.mobileDisplay}
              </div>
      ...
      <section className="container-app py-10 grid gap-6 lg:grid-cols-2">
        <div className="rounded-2xl border border-border bg-card p-6">
          <h2 className="text-xl font-bold flex items-center gap-2">
            <HeartPulse className="h-5 w-5 text-destructive" /> متى تتوجه للطوارئ؟
          </h2>
        ...
        <div className="rounded-2xl border border-border bg-card p-6">
          <h2 className="text-xl font-bold flex items-center gap-2">
            <Ambulance className="h-5 w-5 text-primary" /> إرشادات قبل وصول الإسعاف
          </h2>
          ...
          <div className="mt-6 flex items-start gap-2 text-sm">
            ...
            <a href={SITE.mapsUrl} target="_blank" rel="noreferrer" className="hover:text-primary">
              {SITE.addressAr}
            </a>
          </div>
          <a
            href={`tel:${SITE.phone}`}
            className="mt-4 inline-flex items-center gap-2 rounded-md bg-primary text-primary-foreground px-5 py-2.5 font-semibold"
          >
