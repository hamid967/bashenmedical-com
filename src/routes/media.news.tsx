  ...
  head: () => ({
    meta: [
      ...
      { title: "الأخبار — مجمع باعشن الطبي" },
      {
        name: "description",
        content:
          "آخر أخبار وفعاليات مجمع باعشن الطبي: افتتاحات، شراكات، حملات توعية، وإنجازات طبية.",
      },
...
const news = [
  {
    date: "2026-06-15",
    tag: "افتتاح",
    title: "إطلاق خدمة الاستشارات الطبية عن بُعد",
    excerpt: "أطلق المجمع خدمة استشارات الفيديو مع أطبائه الاستشاريين لتغطية أوسع لسكان المنطقة.",
  },
  {
    date: "2026-05-20",
    tag: "توعية",
    title: "حملة الفحص المبكر لسرطان الثدي",
    excerpt: "بالتعاون مع جمعية زهرة، فحوصات مجانية طوال شهر أكتوبر.",
  },
  {
    date: "2026-04-10",
    tag: "شراكة",
    title: "شراكة مع الهيئة السعودية للتخصصات الصحية",
    excerpt: "برنامج تدريبي جديد للأطباء المقيمين في تخصصات الأسرة والباطنية.",
  },
  {
    date: "2026-03-01",
    tag: "إنجاز",
    title: "تجديد اعتماد CBAHI للسنة الثالثة",
    excerpt: "المجمع يجدد اعتماده كمنشأة صحية معتمدة وفق معايير الجودة السعودية.",
  },
  {
    date: "2026-02-14",
    tag: "مبادرة",
    title: "أيام صحة القلب — فحوصات مجانية",
    excerpt: "فعالية توعوية استمرت 3 أيام بحضور أطباء استشاريين.",
  },
];
    ...
    <>
      ...
      <section className="container-app py-10 grid gap-5 md:grid-cols-2 lg:grid-cols-3">
        {news.map((n) => (
          <article
            key={n.title}
            className="rounded-2xl border border-border bg-card overflow-hidden hover:shadow-lg transition"
          >
