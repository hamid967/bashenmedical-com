...
// UDH-style headline e-services shown as prominent quick-access tiles at the
// top of the hub. Each maps to an existing patient flow.
type Featured = {
  key: string;
  ar: string;
  en: string;
...
function ServicesPortal() {
  ...
  return (
    <div className="min-h-dvh">
      ...
      <section className="container-app relative z-10 -mt-8 md:-mt-10">
