          ...
          <thead>
            <tr>
              ...
              {HOURS.map((h) => (
                <th
                  key={h}
                  className="text-[10px] text-muted-foreground font-normal w-8 text-center"
                >
                ...
                {HOURS.map((h) => {
                  ...
                  return (
                    <td
                      ...
                      title={
                        cell ? `${cell.no_show_rate}% (${cell.no_show}/${cell.total})` : "لا بيانات"
                      }
                    />
                  );
                })}
      ...
      <header className="flex flex-wrap items-center gap-3">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Heatmap + Funnel + Sparklines وتنبيهات الشذوذ
          </p>
        </div>
                        ...
                        return (
                          <tr key={d.doctor_id} className="border-b hover:bg-muted/30">
                            ...
                            <td className="py-2 text-end tabular-nums">
                              <span
                                className={
                                  d.no_show_rate >= 25 ? "text-destructive font-semibold" : ""
                                }
                              >
                                {d.no_show_rate}%
                              </span>
