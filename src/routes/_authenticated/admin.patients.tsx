    ...
    <div className="container-app py-6">
      ...
      <div className="mb-4 relative w-full max-w-md">
        ...
        <input
          ...
          placeholder="بحث بالاسم/MRN/الجوال"
          className="h-9 w-full ps-8 pe-2 rounded-md border bg-background text-sm"
        />
      </div>
      ...
      {query.isLoading ? (
        ...
        <div className="rounded-md border p-8 text-center text-muted-foreground">
          <Inbox className="mx-auto h-8 w-8 mb-2" /> لا يوجد مرضى.
        </div>
      ) : (
