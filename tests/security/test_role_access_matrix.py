...
# NOTE: Runtime probes disabled — Supabase transaction pooler does not
# reliably honor `SET LOCAL ROLE` (no session context / JWT), so probes
# return spurious `permission denied`. Static checks above already
# enforce the allowlist contract.
